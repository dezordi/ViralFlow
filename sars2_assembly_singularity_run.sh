...
#================================================================
#% USAGE
#+    $bash sars2_assembly_singularity_run.sh <REFERENCEGENOME> <001.fastq.gz> <002.fastq.gz> <PREFIX> <NUM_THREADS> <DEPTH> <MIN_LEN> <ADAPTERS> <IMAGE>
#%
#% DESCRIPTION
#%    This script automates the running of sars2_assembly via singularity
#%    
#% OPTIONS
